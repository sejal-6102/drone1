...
// import n1 from "../assets/img/n1.png"; // Replace with actual paths
// import n2 from "../assets/img/n2.png";
// import n3 from "../assets/img/n3.png";
// import "../index.css";
...
//     date: "November 5, 2024",
//     description:
//       "Marut Dronetech has raised $6.2 million, a Series A funding from Lok Capital that is expected to aid the Hyderabad-based...",
//     image: n3,
//   },
// ];
...
//   return (
//     <div className="container py-5">
//       <h2 className="text-center fw-bold">News & Articles</h2>
//       <div className="row justify-content-center mt-4">
//         {newsArticles.map((news, index) => (
//           <motion.div
//             key={index}
//             className="col-12 col-md-4"
//             initial={{ opacity: 0, y: 50 }} // Rise effect on load
